...
ALTER TABLE ONLY public.products
    ADD CONSTRAINT fk_player_id FOREIGN KEY (category_id) REFERENCES public.category(id);

ALTER TABLE ONLY public.products
    ADD CONSTRAINT fk_item_id FOREIGN KEY (supplier_id) REFERENCES public.supplier(id);
