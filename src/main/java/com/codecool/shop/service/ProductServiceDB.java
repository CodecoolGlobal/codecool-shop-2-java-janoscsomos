...
public class ProductServiceDB{
    ...
    public ProductServiceDB(ProductDao productDao, ProductCategoryDao productCategoryDao, SupplierDao supplierDao) {
    ...
    // TO DO - methods which needed to be implemented
